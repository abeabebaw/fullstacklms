...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gradient-to-b from-white via-blue-50/40 to-white text-gray-800">
      <div className="pointer-events-none absolute inset-x-0 -top-24 h-64 bg-[radial-gradient(ellipse_at_top,rgba(59,130,246,0.15),rgba(255,255,255,0))]" />
      ...
      <div className="relative max-w-7xl w-full mx-auto px-6 md:px-10 lg:px-16 py-10 md:py-14 flex-1">
        <div className="max-w-3xl">
          ...
          <h1 className="mt-4 text-3xl md:text-4xl font-extrabold text-gray-900 leading-tight">Get in touch with our team</h1>
        ...
        <div className="mt-10 grid grid-cols-1 xl:grid-cols-3 gap-8 items-start">
          <div className="order-2 xl:order-1 space-y-4">
            ...
            <InfoCard title="Phone" text="+250 700 000 000">
              <IconPhone />
            </InfoCard>
            <InfoCard title="Office" text="Kigali, Rwanda">
              <IconMapPin />
            </InfoCard>
            <div className="p-5 rounded-xl border border-gray-200 bg-white/60 shadow-sm">
              <h3 className="font-semibold text-gray-900">Office Hours</h3>
              <p className="mt-1 text-sm text-gray-600">Mon–Fri, 9:00–17:00 CAT</p>
            </div>
          </div>

          <div className="order-1 xl:order-2 xl:col-span-2">
            <form onSubmit={onSubmit} noValidate className="bg-white/80 backdrop-blur-sm p-6 md:p-8 rounded-2xl border border-gray-200 shadow-xl shadow-blue-100/20 space-y-5">
              {status === "success" ? (
              ...
              <div className="flex items-center justify-between">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 justify-center px-5 py-2.5 rounded-lg bg-blue-600 text-white font-medium hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 disabled:opacity-60"
                >
                  {status === "loading" ? (
                    <>
                      <Spinner /> Sending
